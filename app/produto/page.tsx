            ...
            <div>
              ...
              <div className="flex flex-col md:flex-row gap-4 mb-6">
                ...
                <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                  ...
                  <Input type="text" value={quantity} readOnly className="w-12 h-9 text-center border-0 rounded-none" />
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-9 w-9 rounded-none"
                ...
                <div className="space-y-6">
                  <section>
                    ...
                    <p className="text-dark">
                      A Cadeira Ergonômica Profissional foi projetada para oferecer o máximo de conforto durante longas
                      horas de trabalho. Com design moderno e materiais de alta qualidade, esta cadeira é perfeita para
